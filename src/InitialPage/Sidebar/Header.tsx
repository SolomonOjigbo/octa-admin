...
import { checkApiStatus } from "../../core/redux/apis/status";
...
const handleLogout = () => {
  ...
  useEffect(() => {
    const handleMouseover = (e: MouseEvent) => {
      ...
      if (
        ...
        const target = (e.target as HTMLElement | null)?.closest(".sidebar, .header-left");
  ...
  const toggleFullscreen = (elem?: Element | null) => {
    const doc: any = document;
